return {
    ...
    ["command_setjob2"] = "Définir le second métier d'un joueur",
    ["command_setjob2_job2"] = "Nom du second métier à définir",
    ["command_setjob2_invalid"] = "Le second métier, le grade, ou les deux sont invalides",
