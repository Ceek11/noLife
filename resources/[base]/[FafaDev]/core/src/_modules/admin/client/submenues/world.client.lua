...
local concess_menu = RageUI.CreateSubMenu(builder_menu, "Gestion des Concessionnaires", "Gestion des concessionnaires du serveur")
local TBL_SHOPS = {}
local TBL_CHESTS = {}
local TBL_BOSS = {}
...
function OpenMenuWorldAdmin()
    ...
    RageUI.IsVisible(concess_menu, function()
