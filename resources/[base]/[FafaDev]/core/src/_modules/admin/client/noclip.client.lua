...
-- Event listener pour surveiller les changements de GlobalState.noclip
AddEventHandler('onGlobalStateChange', function(key, value, lastValue)
    if key == 'noclip' then
