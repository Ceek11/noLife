...
Skin.EnableAutoMaskClipping = false                                               -- Fix for face clipping trough the mask.
Skin.GenerateRandomSkin = false                                                   -- Set to false to let players start customization from default freemdoe ped, not the randomized
